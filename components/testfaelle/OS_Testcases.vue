<template>
  <div class="f_neutral_80 border_large shadow_light_1 pb-9">
    <div class="flex flex-row justify-between items-center px-6 pt-6 pb-3">
      ...
      <div
        class="flex items-center justify-center bg_light border_large h-[3rem] w-[8.5rem] p-4"
      >
    ...
    <div
      class="py-0 px-6 mt-6 grid gap-x-[1.625rem] gap-y-6 justify-center"
