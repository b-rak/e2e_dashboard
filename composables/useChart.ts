...
export const useChart = async function(testcaseId: number) {
    ...
    // Bar chart
    new Chart(document.getElementById("bar-chart-" + testcaseId) as HTMLCanvasElement, {
        type: 'bar',
        plugins: [updateColor],
        data: {
...
export const useOverviewChart = async function(osId: number) {
    ...
    const updateColor = {
        ...
        beforeUpdate: function (chartInstance: Chart) {
            ...
            dataset.backgroundColor = numberDataset.map(function (data: number, index: number) {
            ...
            plugins: {
                ...
                datalabels: {
                    ...
                    formatter: function (value, context) {
                        ...
                        return context.dataIndex % 2 === 0 ? value + ' PASSED' : value + ' FAILED'
                    }
                }
            },
            responsive: false,
